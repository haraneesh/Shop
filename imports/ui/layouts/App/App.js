...
import Vision from '../../pages/Miscellaneous/Vision/Vision';
      ...
      <Grid>
        <Switch>
          ...
          */}
          ...
          <Authenticated exact routeName="Update Profile" path="/updateProfile" component={dProfileUpdate} {...props} />
          ...
          <Authenticated exact routeName="EditRecipe" path="/recipes/:_id/edit" component={dEditRecipe} {...props} />
          ...
          <Authenticated routeName="Accept Invitation" path="/invitations/:token" component={Signup} {...props} />

          {/* Specials */}
          <Authenticated exact routeName="View Specials" path="/specials" component={dListSpecials} {...props} />
          <Authenticated exact routeName="Edit Specials" path="/specials/edit" component={dEditAllSpecials} {...props} />
          ...
          {/* Product */}
          <Authenticated exact routeName="View Products Admin" path="/admin/products" component={dProductsAdmin} {...props} />

          {/* Admin */
         /* ProductLists */}
          <Authenticated exact routeName="Edit Products Admin" path="/productLists/:_id/edit" component={dProductsAdmin} {...props} />
          <Authenticated exact routeName="View Product List Details Admin" path="/productLists/:_id" component={dViewProductListDetails} {...props} />
          <Authenticated exact routeName="View Product Lists Admin" path="/productLists" component={dProductLists} {...props} />

          {/* Orders
          <Route routeName="View All Orders Admin" path="/allorders" component={AllOrders} onEnter={authenticate} /> */}

          <Authenticated exact routeName="View All Orders Admin" path="/allorders" component={dAllOrders} {...props} />
          {/* Zoho Sync */}
          <Authenticated exact routeName="Zoho Sync" path="/admin/zohoSync" component={dZohoSyncUp} {...props} />
          {/* end admin */}
          ...
          <Public routeName="Vision" path="pages/vision" component={Vision} />
          {/* Page not found */}
          <Redirect from="*" to="/" />
        </Switch>
      </Grid>
